...
## [2.0.4](https://github.com/Natumsol/obsidian-pangu/compare/2.0.3...2.0.4) - 2026-09-23

### Fixed

- Use each editor window's timers for automatic spacing, including popout windows, and remove an unnecessary regular-expression escape reported by directory review.
- Set GitHub Release titles to their version so directory review can match them to `manifest.json`.
...
## [2.0.2](https://github.com/Natumsol/obsidian-pangu/compare/2.0.1...2.0.2) - 2026-09-22
...
- Correct the minimum Obsidian version to 0.12.16 and enforce it with the official API compatibility rule before release.
- Isolate the negative API regression check in a fresh process: in CI, repeated in-process linting otherwise loses dependency type information.
- Preserve the formatting behavior and legacy settings fallback from 1.7.0.

### Maintenance

- Include the compatibility regression tests and pinned lint tooling prepared for 1.7.1. The 1.7.1 tag remains unchanged; that release was blocked by CI and was not published.

## [1.7.1](https://github.com/Natumsol/obsidian-pangu/compare/1.7.0...1.7.1) - Not published (CI failed)
